                    ...
                    <div style="container">
                        ...
                        @foreach ($applications as $key => $application)
                            <div class="row a_project_application">
                                <div class="col-md-3"><a href="{{route('application.show',['application'=>$application->id])}}">{{ $application->booking->title }}</a></div>
                                <div class="col-md-2">{{ $application->start }}</div>
                                <div class="col-md-2">{{ $application->created_at }}</div>
                                <div class="col-md-1">{{ $application->booking->user->name }}</div>
                                <div class="col-md-2">@if(empty($application->booking->user->contact)){{ $application->booking->user->email }}@else {{ $application->booking->user->contact }} @endif</div>
                                <div class="col-md-2">
